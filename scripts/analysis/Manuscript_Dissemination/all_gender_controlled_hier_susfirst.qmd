---
title: "all gender controlled hier susfirst"
format: docx
date: today
editor: visual
execute:
...
# Hierarchical Regression: All Gender SUS First
...
```{r}
all_gender_controlled_hier_data <- read_csv(here("data", "raw", "rawdata_prelimSSSP_abstract.csv")) |>
  rename(
    age  = Age...6,
    pclr = `PCL-R Total`,
    iq   = IQ,
