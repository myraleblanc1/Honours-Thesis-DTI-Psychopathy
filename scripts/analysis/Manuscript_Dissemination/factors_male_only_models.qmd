...
results_fa_m1_male_factor1 <- results_fa_m1_male |>
  filter(term == "factor1") |>
...
results_roi_fa_model2_factor1_male <- results_roi_fa_model2_male |>
  filter(term == "factor1") |>
  mutate(p_fdr = p.adjust(p.value, method = "fdr"))
...
#| execute:
#|   cache: false
results_roi_fa_model2_factor1_male |>
  select(
    roi,
    estimate,
    std.error,
...
results_fa_m1_male_factor2 <- results_fa_m1_male |>
  filter(term == "factor2") |>
  mutate(p_fdr = p.adjust(p.value, method = "fdr"))
...
results_roi_fa_model2_factor2_male <- results_roi_fa_model2_male |>
  filter(term == "factor2") |>
  mutate(p_fdr = p.adjust(p.value, method = "fdr"))
...
#| execute:
#|   cache: false
results_roi_fa_model2_factor2_male |>
  select(
    roi,
    estimate,
    std.error,
