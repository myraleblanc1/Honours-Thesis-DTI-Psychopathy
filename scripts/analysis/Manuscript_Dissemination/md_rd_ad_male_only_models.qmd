---
title: "rd, ad, md, male-only model 1 & 2"
format: docx
date: today
editor: visual
execute:
...
# Linear Regression: Male-Only AD/MD/RD
...
results_m2 <- map_dfr(metrics, function(m) {
  ...
  roi_dti_male |>
    ...
    group_by(roi) |>
    group_map(
      ~ lm(mean ~ pclr + age + iq + sus, data = .x),
      .keep = TRUE
    ) |>
    set_names(unique(roi_dti_male$roi)) |>
    imap_dfr(
