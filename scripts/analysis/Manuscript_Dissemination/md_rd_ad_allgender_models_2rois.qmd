---
title: "md ad rd all gender models 2roi"
format: docx
date: today
editor: visual
execute:
...
# 2 ROIs: Linear Regression: All Gender AD/MD/RD
...
```{r}
roi_dti_allgender <- roi_dti_allgender %>%
  mutate(
    tract = case_when(
...
results_m2 <- map_dfr(metrics, function(m) {
  ...
  roi_dti_allgender |>
    ...
    set_names(unique(roi_dti_allgender$tract)) |>
    imap_dfr(
      ~ tidy(.x) |>
        mutate(
          tract = .y,
