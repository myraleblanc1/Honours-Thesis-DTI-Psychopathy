This directory will contain all the scripts used to analyze the DTI data for my Honours Thesis project.
...
Preregistration can be found here: https://osf.io/5vzht/overview
